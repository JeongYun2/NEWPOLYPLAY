...
<table class=table1_1  width="800" height="100"   style="margin-left: auto; margin-right: auto;
	text-align: center;">
<tr>
	<th width="200"><a href="<%=request.getContextPath() %>/BoardFAQUserList"><font color="red">회원 </font></a></th>
	<th width="200"><a href="<%=request.getContextPath() %>/BoardFAQPlayerList">플레이어 </a></th>
